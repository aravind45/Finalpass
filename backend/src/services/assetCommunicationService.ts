...
export class AssetCommunicationService {
     ...
     */
    async createCommunication(input: CreateCommunicationInput) {
     ...
     */
    async getCommunications(assetId: string) {
     ...
     */
    async updateCommunication(communicationId: string, input: UpdateCommunicationInput) {
     ...
     */
    async getCommunicationTimeline(assetId: string) {
     ...
     */
    async getNextActions(assetId: string) {
     ...
     * Update asset metadata with last contact date
     */
    private async updateAssetLastContact(assetId: string) {
     ...
     */
    private async checkEscalationNeeded(assetId: string) {
     ...
     */
    async getCommunicationStats(assetId: string) {
        const communications = await prisma.assetCommunication.findMany({
            where: { assetId }
        });
