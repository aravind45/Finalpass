...
export class FollowUpService {
     ...
     */
    async getFollowUpRecommendations(estateId) {
     ...
     */
    async getAssetFollowUpRecommendations(assetId) {
     ...
     */
    async createEscalation(assetId, reason, daysSinceContact) {
     ...
     */
    async getOpenEscalations(estateId) {
